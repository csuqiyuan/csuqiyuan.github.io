...
top: false
toc: true
date: 2020-01-12 17:38:55
description: 我虽然也写过一段时间前端，但对前端的发展历史并没有什么了解，总是盲目地进行前后端分离和 MVVC。这篇文章以及其姊妹篇 “Node.js 换个角度看世界” 对前端的整体发展历程和后面客户端/服务端渲染之争有了较完整的描述。
thumbnail: https://res.cloudinary.com/dkzvjuptx/image/upload/v1578824486/%E5%89%8D%E7%AB%AF/%E5%89%8D%E7%AB%AF%E5%8F%91%E5%B1%95%E7%AE%80%E5%8F%B2/0_yvqyhl.png
tags:
- 前端
- 前端发展史
categories: 前端
keywords: 前端, 历史, 前端发展简史
---

在知乎上闲逛，偶尔看到一篇文章讲前端发展简史的，感觉写的还蛮不错。我虽然也写过一段时间前端，但对前端的发展历史并没有什么了解，总是盲目地进行前后端分离和 MVVC，不知道服务端渲染和客户端渲染的优劣，不明白 node 中间层存在的意义，反正大家都这么做，我也就跟着这么做，这篇文章以及其姊妹篇 “Node.js 换个角度看世界” 对前端的整体发展历程和后面客户端/服务端渲染之争有了较完整的描述。经作者本人同意，转载到自己的博客上。

原文[点击这里]( https://zhuanlan.zhihu.com/p/91842778 )
...
![](https://res.cloudinary.com/dkzvjuptx/image/upload/v1578823581/前端/前端发展简史/1_xmyqpd.jpg) 简单说就是
...
![](https://res.cloudinary.com/dkzvjuptx/image/upload/v1578823581/前端/前端发展简史/2_ybopzw.jpg)
...
![](https://res.cloudinary.com/dkzvjuptx/image/upload/v1578823581/前端/前端发展简史/3_lzotkq.jpg)
...
![](https://res.cloudinary.com/dkzvjuptx/image/upload/v1578823579/前端/前端发展简史/4_w0o4q9.jpg)

 我们在浏览器中任意打开一个页面的源码，都会看到类似如下的内容： 

![](https://res.cloudinary.com/dkzvjuptx/image/upload/v1578823578/前端/前端发展简史/5_drtyp8.jpg)
...
![](https://res.cloudinary.com/dkzvjuptx/image/upload/v1578823578/前端/前端发展简史/6_he75ca.jpg)

 每一个有追求有品味的页面，都在借 `CSS` 给浏览者说一句话："**我怎么这么好看！**" 

![](https://res.cloudinary.com/dkzvjuptx/image/upload/v1578823579/前端/前端发展简史/7_xtebla.jpg)
...
![](https://res.cloudinary.com/dkzvjuptx/image/upload/v1578823579/前端/前端发展简史/8_elu07u.jpg)

 如果用一个人来作比喻网页的话，`HTML` 就是一个人的骨骼， `CSS` 就是一个人的血肉，而 **`JS` 则是一个人的灵魂**！ 

![](https://res.cloudinary.com/dkzvjuptx/image/upload/v1578823579/前端/前端发展简史/9_zf0gpx.jpg)
...
![](https://res.cloudinary.com/dkzvjuptx/image/upload/v1578823579/前端/前端发展简史/10_ip2x1m.jpg)
...
创业公司的特点是开发团队人数不多，但有一个共同点：技术leader是从大公司历练出来的，因为船小好掉头的原因，往往技术的实效性要比大型互联网公司好一些。 而大型互联网公司的特点是体系、流程很完善(久经考验的)，服务的用户、体量都非常大，部门人数多、协同开发的机制很完善，内部不缺比你牛逼的人，身边的同事都不是特别菜的，可能最菜的就是你自己。
...
![](https://res.cloudinary.com/dkzvjuptx/image/upload/v1578823580/前端/前端发展简史/11_elznla.jpg)
...
![](https://res.cloudinary.com/dkzvjuptx/image/upload/v1578823579/前端/前端发展简史/12_xbtzqn.jpg)
...
![](https://res.cloudinary.com/dkzvjuptx/image/upload/v1578823580/前端/前端发展简史/13_krlwhd.jpg)
...
![](https://res.cloudinary.com/dkzvjuptx/image/upload/v1578823579/前端/前端发展简史/14_dcg5oi.jpg)
...
![](https://res.cloudinary.com/dkzvjuptx/image/upload/v1578823580/前端/前端发展简史/15_t6iyos.jpg)
...
![](https://res.cloudinary.com/dkzvjuptx/image/upload/v1578823580/前端/前端发展简史/16_rsoizp.jpg)
...
![](https://res.cloudinary.com/dkzvjuptx/image/upload/v1578823580/前端/前端发展简史/17_twic92.jpg)

 Vue也可以算是 MVVM 模型，虽然它没有完全遵守 MVVM 的设计，但受到了 MVVM 的启发，在最开始的时候也是双向数据绑定，并且一直使用 vm 表示 View-Model。就以 Vue为例，简单看下 MVVM 的思想。 

![](https://res.cloudinary.com/dkzvjuptx/image/upload/v1578823580/前端/前端发展简史/18_zsps0r.jpg)

![](https://res.cloudinary.com/dkzvjuptx/image/upload/v1578823580/前端/前端发展简史/19_xsuv93.jpg)

### SPA (single-page application)

SPA 是单页应用的意思，它是区分传统模式而言的。我们一开始就探讨过从输入URL到页面呈现在我们面前的过程，也熟悉了 `HTML` 、 `CSS` 和 `JS`。现在换个角度来看这个过程：

![](https://res.cloudinary.com/dkzvjuptx/image/upload/v1578823580/前端/前端发展简史/20_zahijm.jpg)
...
![](https://res.cloudinary.com/dkzvjuptx/image/upload/v1578823580/前端/前端发展简史/21_ozsza8.jpg)
...
![](https://res.cloudinary.com/dkzvjuptx/image/upload/v1578823580/前端/前端发展简史/22_rawqx6.jpg)

 于是，现在又争先恐后的回到服务端渲染，想想真得挺可笑的，十年前为了搭上 Ajax 的班车纷纷做SPA，做客户端渲染，现在反而又想着法儿的要重新做服务端渲染。 

![](https://res.cloudinary.com/dkzvjuptx/image/upload/v1578823581/前端/前端发展简史/23_onkm1p.jpg)
...
[JavaScript 语言的历史](https://link.zhihu.com/?target=https%3A//wangdoc.com/javascript/basic/history.html)

[大前端的技术原理和变迁史](https://link.zhihu.com/?target=https%3A//juejin.im/post/5b5adc9b6fb9a04f9244555d)

[History of front-end frameworks](https://link.zhihu.com/?target=https%3A//logrocket.com/blog/history-of-frontend-frameworks/)

[WEB前端发展史](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/s/gNtpdMRL6JqNMr_tJsCVdA)

[万维网 WWW 的三十年](https://link.zhihu.com/?target=https%3A//www.linkresearcher.com/information/cb9aadac-a124-4708-b4f7-ecb4fd804bdb)
